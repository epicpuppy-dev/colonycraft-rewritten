...
export class CraftingJob extends Job {
    ...
    constructor(game: ColonyCraft, id: string, name: string, priority: number, crafts: number, recipe: Recipe, unlocked: (game: ColonyCraft) => boolean, maxWorkers: (game: ColonyCraft) => number) {
