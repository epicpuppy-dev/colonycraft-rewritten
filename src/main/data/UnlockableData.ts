...
export class UnlockableData {
    public static addUnlockables (game: ColonyCraft, research: ResearchManager, development: TraitManager) {
        ...
        research.registerTechnology(new Technology(game, "composite1", "Clay Working", new TechPoints(130), ["Unlocks the Unfired Brick Recipe", " ", '"Clay is very soft and easy to work with"'], ["digging1"], "progress"));
