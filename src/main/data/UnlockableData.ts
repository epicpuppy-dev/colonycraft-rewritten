...
export class UnlockableData {
    public static addUnlockables (game: ColonyCraft, research: ResearchManager, development: TraitManager) {
        ...
        research.registerTechnology(new Technology(game, "math2", "Intermediate Mathematics", new TechPoints(500, 300), ['"5 x 5 = 25"'], ["math1"], "progress"));
        ...
        research.registerTechnology(new Technology(game, "build1", "Basic Construction", new TechPoints(40), ["Unlocks the Builder Job", "", '"The idea that some things are more stable than others"'], ["crafting1", "survival1"], "progress"));
        ...
        research.registerTechnology(new Technology(game, "farming1", "Basic Farming", new TechPoints(150, 75), ["Unlocks Farming Buildings and Jobs", "New crops will unlock a new job and building", "", '"A sustainable source of food"'], ["tools1", "survival1", "math1"], "food"));
        ...
        // Gathering Tech Line
        research.registerTechnology(new Technology(game, "gatherer1", "Gathering", new TechPoints(125, 50), ["Unlocks the Gatherer Job", "Gathers twice as fast as foragers, but cannot gather water", "", '"Foragers with baskets can hold a whole lot more"'], ["baskets1", "survival1", "math1"]));
        ...
        research.registerTechnology(new Technology(game, "fishing1", "Hand Fishing", new TechPoints(75), ["Unlocks the Fisher Job", "More consistent, but slightly less rewarding than hunting", "", '"Much harder to catch than it seems"'], ["survival1"], "food"));
        research.registerTechnology(new Technology(game, "fishing2", "Spear Fishing", new TechPoints(150, 75), ["Unlocks the Spear Fisher Job", "", '"A much more effective way of catching fish"'], ["fishing1", "tools2", "math1"], "food"));
        research.registerTechnology(new Technology(game, "hunting1", "Endurance Hunting", new TechPoints(100), ["Unlocks the Hunter Job", "More variable, but slightly more rewarding than fishing", "", '"Hunting animals for food"'], ["survival1"], "food"));
        research.registerTechnology(new Technology(game, "hunting2", "Spear Hunting", new TechPoints(200, 100), ["Unlocks the Spear Hunter Job", "", '"A much more effective way of hunting"'], ["hunting1", "tools2", "math1"], "food"));
        research.registerTechnology(new Technology(game, "water1", "Water Gathering", new TechPoints(100), ["Unlocks the Water Gatherer Job", "", '"By training foragers to use buckets, they can collect more water"'], ["buckets1", "explore1"]));

        // Cooking Tech Line
        research.registerTechnology(new Technology(game, "cooking1", "Cooking", new TechPoints(75), ["Unlocks the Cooking Jobs", "", '"Cooking food makes it taste better"'], ["survival1", "fire1"], "food"));

        // Farming Tech Line
        research.registerTechnology(new Technology(game, "wheat1", "Wheat Farming", new TechPoints(150, 75), ["Unlocks the Wheat Crop", "(Grows fast, but not in the winter or spring)", "", '"Tastes bad 0/10 wouldn\'t reccommend"'], ["farming1"], "food"));
        research.registerTechnology(new Technology(game, "potato1", "Potato Farming", new TechPoints(150, 75), ["Unlocks the Potato Crop", "(Grows slow, but during the entire year)", "", '"The perfect size to throw at people"'], ["farming1"], "food"));

        // Baking Tech Line
        research.registerTechnology(new Technology(game, "flour1", "Wheat Processing", new TechPoints(200, 100), ["Unlocks the Flour Recipe", "(Crafts 2 wheat -> 2 flour)", "", '"Can be used to make a vareity of foods"'], ["wheat1"], "food"));
        research.registerTechnology(new Technology(game, "bread1", "Bread", new TechPoints(250, 125), ["Unlocks the Bread Recipe", "(Crafts 2 flour + 1 fresh water -> 1 bread)", "", '"A simple food made from flour and water"'], ["flour1", "water1", "bakery1"], "food"));
        ...
        research.registerTechnology(new Technology(game, "tools2", "Toolmaking", new TechPoints(100, 50), ["Unlocks the Basic Tools Recipe", "(Crafts 2 primitive tools + 4 twine -> 1 basic tool)", "", '"Putting together some rocks and sticks"'], ["tools1", "math1", "twine1"], "progress"));
        ...
        research.registerTechnology(new Technology(game, "baskets1", "Basket Weaving", new TechPoints(100), ["Unlocks the Basket Recipe", "(1 cloth + Crafts 4 twine -> 1 basket)", "", '"Baskets are useful for carrying things"'], ["twine1", "tools1"]));
        ...
        research.registerTechnology(new Technology(game, "storage1", "Stockpiling", new TechPoints(50, 20), ["Unlocks the Storage Pit Building", "Unlocks precise inventory", "", '"Put stuff in hole"'], ["build1", "math1"], "progress"));
        ...
        research.registerTechnology(new Technology(game, "bakery1", "Baking", new TechPoints(100), ["Unlocks the Basic Oven Building", "", '"Bread."'], ["composite1", "cooking1", "build1"]));
