...
export class UnlockableData {
    public static addUnlockables (game: ColonyCraft, research: ResearchManager, development: TraitManager) {
        ...
        research.registerTechnology(new Technology(game, "twine1", "Plant Twine", new TechPoints(30), ["Unlocks the Plant Twine Recipe", "(Crafts 4 fibre -> 1 twine)", "", '"Roll grass make rope"'], ["crafting1"]));
        ...
        development.registerTrait(new WelfareTrait(game, "hope", "Hope", "s", 500, 0, 2, ["Belief in the future", "+0.2% base morale per tick"], ["survival2", "fire1", "acceptance"]));
    }
}