...
export class InventoryData {
    public static addItems (game: ColonyCraft, inventory: Inventory) {
        ...
        inventory.addCategoryWithItems(new ItemGroup("food", "Food"), [
            ...
            new FoodItem(game, "cookedMeat", 0.25, "Cooked Meat", 0.04, 0.5, 2, 3, 10), //O
        ...
        inventory.addCategoryWithItems(new ItemGroup("basic", "Basic Materials"), [
            new Item(game, "composite", 4, "Brick Composite", 0.01), //O
            new Item(game, "twine", 0.1, "Plant Twine", 0.005), //O
            new Item(game, "cloth", 0.1, "Cloth", 0.005), //O
        ]);
        inventory.addCategoryWithItems(new ItemGroup("lumber", "Lumber"), [
            new Item(game, "logs", 4, "Logs", 0.01), //O
            new Item(game, "planks", 1, "Planks", 0.0075), //O
            new Item(game, "beams", 0.5, "Beams", 0.0075), //
        ]);
        inventory.addCategoryWithItems(new ItemGroup("agriculture", "Agriculture"), [
            new Item(game, "wheat", 1, "Wheat", 0.005), //O
            new Item(game, "flour", 1, "Flour", 0.0025), //O
        ...
        inventory.addCategoryWithItems(new ItemGroup("building", "Building Materials"), [
            ...
            new Item(game, "bricks", 2, "Bricks", 0.002), //O
        ]);
        inventory.addCategoryWithItems(new ItemGroup("metallurgy", "Metallurgy"), [
            new Item(game, "copper", 2, "Copper", 0.002), //O
            new Item(game, "tin", 2, "Tin", 0.002), //O
            new Item(game, "iron", 2, "Iron", 0.002), //
            new Item(game, "zinc", 2, "Zinc", 0.002), //
            new Item(game, "bronze", 2, "Bronze", 0.002), //O
            new Item(game, "steel", 2, "Steel", 0.002), //
            new Item(game, "silicon", 2, "Silicon", 0.002), //
            new Item(game, "gold", 2, "Gold", 0.002), //
        ]);
