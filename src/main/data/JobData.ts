...
export class JobData {
    public static addJobs (game: ColonyCraft, jobs: JobManager) {
        ...
        // Gathering Jobs
        jobs.addGroupWithJobs(new JobGroup("gather", "Gathering"), [
            new ResourceJob(game, "forager", "Forager", 0, 10, tables.forager, () => true, () => Infinity),
            ...
            new ResourceJob(game, "fisher1", "Hand Fisher", 0, 10, tables.fish, () => techs.fishing1.unlocked, () => Infinity),
            ...
            new ResourceJob(game, "hunter1", "Endurance Hunter", 0, 10, tables.hunter, () => techs.hunting1.unlocked, () => Infinity),
        ...
        // Farming Jobs
        jobs.addGroupWithJobs(new JobGroup("farm", "Farming"), [
        ...
        // Exploration Jobs
        jobs.addGroupWithJobs(new JobGroup("explore", "Exploration"), [
            new Job(game, "explorer1", "Scout", 10, () => techs.explore1.unlocked, () => Infinity, "Explores the surrounding area"),
        ]);

        // Discovery Jobs
        jobs.addGroupWithJobs(new JobGroup("discover", "Discovery"), [
            ...
            new Job(game, "chemistry1", "Chemist", 20, () => false, () => Infinity, "Generates Chemistry Discoveries"),
        ...
        // Development Jobs
        jobs.addGroupWithJobs(new JobGroup("develop", "Development"), [
        ...
        // Building Jobs
        jobs.addGroupWithJobs(new JobGroup("build", "Construction"), [
        ...
        // Production Jobs
        //  - Intermediate
        jobs.addGroupWithJobs(new JobGroup("matCrafters", "Material Crafters"), [
        ...
        //  - Tools
        jobs.addGroupWithJobs(new JobGroup("toolCrafters", "Tool Crafters"), [
        ...
        //  - Amenities
        jobs.addGroupWithJobs(new JobGroup("amenityCrafters", "Amenity Crafters"), [
        ...
        //  - Food
        jobs.addGroupWithJobs(new JobGroup("foodCrafters", "Food Crafters"), [
