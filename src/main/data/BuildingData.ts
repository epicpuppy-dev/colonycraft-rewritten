...
export class BuildingData {
    public static addBuildings (game: ColonyCraft, manager: BuildingManager) {
        ...
        manager.addBuilding(new StorageBuilding(game, "storage2", "Storage Hut", 2, 25, 0, 25, ["+25 storage capacity"], [{item: items.planks, amount: 25}, {item: items.rocks, amount: 20}, {item: items.leaves, amount: 100}], () => techs.storage2.unlocked, () => Infinity));
