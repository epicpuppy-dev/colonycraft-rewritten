...
export class BuildingData {
    public static addBuildings (game: ColonyCraft, manager: BuildingManager) {
        ...
        manager.addBuilding(new Building(game, "copper1", "Copper Furnace", 2, 250, 0, ["Allows the smelting of copper"], [{item: items.bricks, amount: 24}, {item: items.logs, amount: 8}], () => techs.copper1.unlocked));
        manager.addBuilding(new Building(game, "tin1", "Tin Furnace", 2, 250, 0, ["Allows the smelting of tin"], [{item: items.bricks, amount: 24}, {item: items.logs, amount: 8}], () => techs.tin1.unlocked));
        manager.addBuilding(new Building(game, "bronze1", "Bronze Crucible", 4, 750, 0, ["Allows the alloying of bronze"], [{item: items.bricks, amount: 96}, {item: items.coal, amount: 36}, {item: items.tool3, amount: 24}], () => techs.bronze1.unlocked));
